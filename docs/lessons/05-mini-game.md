...
<Quiz :questions="[
  { q: '游戏中的「反馈」是什么意思？', options: ['玩家给游戏的评价', '游戏让玩家感受到操作产生了效果，比如翻牌动画、配对成功的音效', '游戏的分数', '游戏的规则'], answer: 1 },
  { q: '怎样向 Claude Code 描述一个 bug？', options: ['说「游戏坏了」就行', '具体说：做了什么 → 看到了什么 → 应该怎样，越详细越好', '只需要说出现了一个错误', '不用描述，自己想办法修'], answer: 1 },
  { q: 'Bug 这个词的来历是什么？', options: ['因为代码里经常出现虫子图标', '早期有一只飞蛾飞进了计算机导致故障，从此程序错误就叫 bug', '因为 bug 是英文中错误的意思', '这是最新发明的计算机术语'], answer: 1 }
]" />
...
::: tip 参考示例
想看看完成后的效果？下载示例代码：[点击下载](/examples/lesson05-memory-game.html)
