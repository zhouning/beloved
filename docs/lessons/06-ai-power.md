...
<Quiz :questions="[
  { q: 'API 的作用是什么？', options: ['让程序跑得更快', '两个程序之间对话的方式——一个发请求，另一个处理并返回结果', '用来装饰网页的工具', '一种网络游戏'], answer: 1 },
  { q: 'AI 为什么能「创造」新的故事？', options: ['因为 AI 真的有大脑', '因为 AI 读了大量故事，学会了模式，能预测接下来最可能出现什么', '因为 AI 有魔法', '因为故事是预先写好的'], answer: 1 },
  { q: '我们做的故事生成器用了什么原理？', options: ['连接到真实的 AI 服务器', '预设素材库 + 随机组合，就像 AI 的简化版', '让用户自己手动写故事', '从互联网上随机抓取故事'], answer: 1 },
  { q: 'API Key 是什么？', options: ['打开任何网站的密钥', '使用某个 API 服务所需的通行证，证明你有权限', '一种加密算法', 'Claude Code 的密码'], answer: 1 }
]" />
...
::: tip 参考示例
想看看完成后的效果？下载示例代码：[点击下载](/examples/lesson06-story-generator.html)
