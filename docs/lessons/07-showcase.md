...
<Quiz :questions="[
  { q: '作品集（Portfolio）的作用是什么？', options: ['只是用来展示好看的网页', '展示你做过的所有项目，比证书更能证明你的能力', '存储你的源代码', '一种编程工具'], answer: 1 },
  { q: '项目生命周期的四个阶段是什么？', options: ['计划 → 编码 → 测试 → 发布', '想法 → 构建 → 打磨 → 分享', '设计 → 开发 → 安装 → 卸载', '学习 → 练习 → 考试 → 毕业'], answer: 1 },
  { q: 'GitHub Pages 的作用是什么？', options: ['只能用来存放代码', '免费把你的网页发布到互联网上，让别人通过网址访问', '一个社交媒体平台', '一个付费的网站建设工具'], answer: 1 },
  { q: '通过这7节课，你学到的最重要的能力是什么？', options: ['最新的编程语言语法', '把想法变成清晰描述、拆解问题、调试排错——和 AI 协作的能力', '如何快速背诵代码', '记住所有 HTML 标签'], answer: 1 }
]" />
...
::: tip 参考示例
想看看完成后的效果？下载示例代码：[点击下载](/examples/lesson07-portfolio.html)
